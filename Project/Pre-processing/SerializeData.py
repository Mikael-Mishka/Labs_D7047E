...
def run() -> None:
    ...
    # How many runs we want to do in order to average the test_accuracies
    RUNS = 20
    test_accuracies = []
    test_losses = []
    ...
    for run in range(RUNS):
        ...
        test_average_accuracy, test_loss = test_model(model, test_loader, criterion)
        ...
        print(f"Average test accuracy: {sum(test_accuracies)/len(test_accuracies)} for run = {run+1}, test_loss = {test_loss}")
